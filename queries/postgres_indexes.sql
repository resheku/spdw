...
ALTER TABLE spdw_telemetry_stats ADD CONSTRAINT PK_spdw_telemetry_stats_match_id PRIMARY KEY (match_id);
...
CREATE INDEX IF NOT EXISTS spdw_telemetry_stats_track_match_idx ON spdw_telemetry_stats(track_city, match_id);
