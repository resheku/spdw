...
CREATE TEMP TABLE temp_track_stats_historical AS SELECT * FROM sel.track_stats_historical;
...
CREATE TABLE pg.track_stats_historical AS SELECT * FROM temp_track_stats_historical;
...
DROP TABLE temp_track_stats_historical;
